  ...
  const prefix0.JsonSerializable(): r.ReflectorData(
      <m.TypeMirror>[
        r.NonGenericClassMirrorImpl(
            r'ImmutableClass',
            r'json_mapper_fixnum.example.ImmutableClass',
            7,
            0,
            ...
            {},
            {
              r'': (bool b) => (list) => b ? prefix1.ImmutableClass(list) : null
            },
            -1,
            0,
            const <int>[],
      ...
      <m.DeclarationMirror>[
        ...
        r.MethodMirrorImpl(
            ...
            const prefix0.JsonSerializable(),
            const []),
        r.MethodMirrorImpl(r'hashCode', 131075, -1, -1, 3, 3, const <int>[],
            const <int>[], const prefix0.JsonSerializable(), const []),
        r.MethodMirrorImpl(r'runtimeType', 131075, -1, -1, 6, 6, const <int>[],
            const <int>[], const prefix0.JsonSerializable(), const [])
      ],
      <m.ParameterMirror>[
      ...
      <Type>[
        prefix1.ImmutableClass,
        const m.TypeValue<prefix2.BuiltList<int>>().type,
        prefix2.BuiltList,
        int,
        bool,
        String,
...
final exampleGeneratedAdapter = JsonMapperAdapter(
    ...
    valueDecorators: {
      typeOf<List<x0.ImmutableClass>>(): (value) =>
          value.cast<x0.ImmutableClass>(),
      typeOf<Set<x0.ImmutableClass>>(): (value) =>
          value.cast<x0.ImmutableClass>()
    },
    enumValues: {});
