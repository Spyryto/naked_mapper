  ...
  const prefix0.JsonSerializable(): r.ReflectorData(
      <m.TypeMirror>[
        r.NonGenericClassMirrorImpl(
            r'MobX',
            r'json_mapper_mobx.example.MobX',
            7,
            0,
            ...
            {
              r'': (bool b) =>
                  (mailingList) => b ? prefix1.MobX(mailingList) : null
            },
            -1,
            0,
            const <int>[],
      ...
      <m.DeclarationMirror>[
        ...
        r.MethodMirrorImpl(
            ...
            const prefix0.JsonSerializable(),
            const []),
        r.MethodMirrorImpl(r'hashCode', 131075, -1, -1, 5, 5, const <int>[],
            const <int>[], const prefix0.JsonSerializable(), const []),
      ...
      <Type>[
        prefix1.MobX,
        const m.TypeValue<prefix2.ObservableList<String>>().type,
        prefix2.ObservableList,
        String,
        bool,
        int,
        Type,
